...
% \begin{itemize}
%     \item \textbf{Alfabet} ($\Sigma$) -- DOWOLNY skończony zbiór symboli.
%     \item \textbf{Słowo} ($w$) -- dowolny skończony ciąg symboli należących do alfabetu.
...
%     \item \textbf{Kodowanie} -- reprezentacje obiektów (takich jak automaty czy wyrażenia) są traktowane jako słowa nad ustalonym alfabetem.
        \item {Długosc slowa} -- liczba symboli wystepujacych w tym slowie
% \end{itemize}
